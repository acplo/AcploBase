<?php
namespace AcploBaseTest\DBAL\Types;

use AcploBase\DBAL\Types\UtcDateTimeType;
use AcploBaseTest\TestCase;
use Doctrine\DBAL\Types\Type;
use AcploBaseTest\DBAL\Mocks\MockPlatform;
...
class UtcDateTimeTypeTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        if (!Type::hasType('utcdatetime')) {
            Type::addType('utcdatetime', 'AcploBase\DBAL\Types\UtcDateTimeType');
        }
