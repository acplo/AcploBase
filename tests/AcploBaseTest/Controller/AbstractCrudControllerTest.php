<?php
namespace AcploBaseTest\Controller;

use AcploBaseTest\Assets\Controller\CrudController;
use Zend\Http\PhpEnvironment\Response;
use AcploBaseTest\Assets\Entity\TestEntity;
use AcploBaseTest\TestCase;
...
class AbstractCrudControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('AcploBaseTest\Assets\Service\TestService', $this->controller->getEntityService());
    }
    ...
    {
        $this->assertSame('AcploBaseTest\Assets\Entity\TestEntity', $this->controller->getEntityClass());
    }
    ...
    {
        $this->assertSame('AcploBaseTest\Assets\Service\TestService', $this->controller->getEntityServiceClass());
    }
    ...
    public function testAddAction()
    {
        ...
        $this->assertInstanceOf('AcploBaseTest\Assets\Entity\TestEntity', $ret['entity']);
        $this->assertInstanceOf('AcploBase\Form\AbstractForm', $ret['entityForm']);
